...
public class MetricMainInfoBuilder implements MetricBuilder {
    ...
    private Metric buildMainMetricInfo(
        ...
        metricList.add("Начальная дата|" + (startDate.equals(OffsetDateTime.MIN) ? "-" : startDate.toString()));
        metricList.add("Конечная дата|" + (endDate.equals(OffsetDateTime.MAX) ? "-" : endDate.toString()));
