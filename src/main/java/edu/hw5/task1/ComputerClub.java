...
public final class ComputerClub {
    ...
    public static String countSession(List<String> sessions) {
        if (sessions == null || sessions.isEmpty()) {
            throw new IllegalArgumentException("Sessions can't be null or empty");
        }
        ...
        for (String session : sessions) {
            ...
            if (sessionMatcher.find()) {
                ...
                if (startSession.isAfter(endSession)) {
                    throw new IllegalArgumentException("Begin of the session can't be later than end of it");
                }
