...
public class SingleThreadPasswordHackerTest {
    @Test
    @DisplayName("hackPassword single thread test")
    public void hackPassword_shouldReturnCorrectMapOfUsersAndPasswords() {
        ...
        assertThat(new SingleThreadPasswordHacker(leakedPasswords).hackPassword()).containsExactlyInAnyOrderEntriesOf(
            passwords);
    }
}

//93f725a07423fe1c889f448b33d21f46: java
//ef0cc10ff462af3af3e15f592c4ec8da: tokyo
//65fa18d1e48eb9bf8844df126d662fc0: ghoul
//a1e05ee2564dbf16b04f09a23d482d06: cola
